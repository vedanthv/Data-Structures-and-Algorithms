...
/*In this problem, first all the bulbs are turned off and then when they are toggled
  they are turned on given the condition that in the first iteration only the first bulb is toggled and in the 2nd iteration every second is toggled and for every nth iteration every nth bulb is toggled. 
